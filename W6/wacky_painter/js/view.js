...
View.prototype.exercise2 = function () {
  ...
  $('.square').css("outline", "0px solid white");
};
...
View.prototype.exercise3 = function () {
  ...
  const $jqueryLove = $("<h1></h1>");
  $jqueryLove.text("I Love jQuery!");
  $('body').append($jqueryLove);
};
...
View.prototype.exercise5 = function () {
  ...
  $('.square').on("click", event => {
    const $currSquare = $(event.currentTarget);
    const position = $currSquare.attr("data-pos")
    alert(position);
  })
};
...
View.prototype.exercise7 = function(){
  ...
  $('.square').on("mouseover", event => {
    const $currSquare = $(event.currentTarget);
    console.log($currSquare.attr("style"));
  })
};
